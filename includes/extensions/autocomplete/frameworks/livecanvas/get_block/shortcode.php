...
function get_lc_section_completions() {
    ...
    $valueShortcode = '<div class="live-shortcode" lc-helper="shortcode">[lc_get_post post_type="lc_block" slug="' . esc_attr($post->post_name) . '"]</div>';

    return [
        'caption' => 'lc_get_post:block: ' . esc_html($post->post_title),
