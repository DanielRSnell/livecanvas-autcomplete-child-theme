...
// Add the add_core_framework_completions function to the 'lc_modify_completions' filter hook.
add_filter('lc_modify_completions', 'add_core_framework_completions');